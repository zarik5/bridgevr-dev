...
// #define string dummy_string
// #define vector dummy_vector
...
FORWARD_FN(VRServerDriverHost, void, vrServerDriverHost, TrackedDeviceDisplayTransformUpdated,
           uint32_t, HmdMatrix34_t, HmdMatrix34_t);
