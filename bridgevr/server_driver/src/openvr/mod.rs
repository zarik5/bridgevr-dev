...
use bridgevr_common::{data::*, graphics::*, input_paths::*, sockets::*, *};
use hmd::*;
use log::*;
...
impl VrServer {
    pub fn new(
        ...
        // let controllers_contexts = tracked_devices_contexts.clone()
        //     .iter()
        //     .map(|(_, ctx)| ctx.clone())
        //     .collect::<Vec<_>>();
        ...
        let server_context = Arc::new(ServerContext {
            ...
            // tracked_devices_contexts: tracked_devices_contexts,
